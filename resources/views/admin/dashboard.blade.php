...
@section('content')
    <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5 flex items-center gap-4 opacity-75">
                <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center text-2xl">
                    📊
                </div>
                <div>
                    <p class="font-semibold text-gray-900 dark:text-white">System Overview</p>
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $stats['total_students'] }} students · {{ $stats['total_instructors'] }} instructors</p>
                </div>
            </div>
        </div>
