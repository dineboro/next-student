        ...
        <div class="bg-white shadow-md rounded-lg px-8 py-6">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="text-center mt-4 space-y-1">
                    ...
                    <a href="{{ route('password.forgot') }}" class="block text-sm text-gray-500 hover:text-gray-700">
                        Forgot password?
                    </a>
                    <a href="{{ route('email.forgot') }}" class="block text-sm text-gray-500 hover:text-gray-700">
                        Forgot email?
                    </a>
                </div>
{{--                <!-- Add this -->--}}
